package com.example.nurserostering.controller;
...
import com.example.nurserostering.exception.ResourceNotFoundException;
import com.example.nurserostering.model.FrontEndData;
import com.example.nurserostering.model.Nurse;
import com.example.nurserostering.repository.FrontEndDataRepo;
import com.example.nurserostering.repository.NurseRepository;

@CrossOrigin(origins = "http://localhost:3000")
@RestController
@RequestMapping("/api/v1")
public class NurseRosteringController {
	
	@Autowired
	private NurseRepository nurseRepository;

	@Autowired
	private FrontEndDataRepo frontEndDataRepository;
